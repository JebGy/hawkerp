          ...
          <input
            ...
            className={
              error
                ...
                : "mb-5 text-black w-full p-2 outline-none focus:border-b-2 focus:border-orange-500 border-2 border-gray-300 rounded-lg"
            }
          />
          <input
            type="number"
            ...
            className="mb-5 w-full text-black p-2 outline-none border-2 border-gray-300 rounded-lg focus:border-b-2 focus:border-orange-500"
          />

          <button
            type="submit"
            className="bg-gradient-to-r from-orange-500 to-orange-700 text-white rounded-full w-full p-2 hover:shadow-xl hover:shadow-orange-300 transition-all"
          >
            {
                  ...
                  <div
                    className={
                      nowEditing && areaToEdit.id === area.id
                        ? "w-full flex flex-col justify-start items-start p-3 text-black bg-orange-200 shadow-lg mb-5 rounded-xl border-2 border-orange-500"
