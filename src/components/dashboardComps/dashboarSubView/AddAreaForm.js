    ...
    <div className="grid grid-cols-4 w-full row-span-5 transition-all">
          ...
          <input
            ...
            className={
              error
                ...
                : "mb-5 text-black w-full p-2 outline-none focus:border-b-2 focus:border-black-500 border-2 border-gray-300 rounded-lg"
            }
          />
          <input
            type="number"
            ...
            className="mb-5 w-full text-black p-2 outline-none border-2 border-gray-300 rounded-lg focus:border-b-2 focus:border-black-500"
          />

          <button
            type="submit"
            className="bg-gradient-to-r from-black-500 to-blue-400 text-white rounded-full w-full p-2 hover:shadow-xl hover:shadow-black-500 transition-all"
          >
            {
      ...
      <div className="w-full h-full col-span-full lg:col-span-3 flex flex-col overflow-hidden p-5">
        <div className="w-full flex flex-row justify-between items-center">
          ...
          <button
            className="bg-gradient-to-r from-black-500 to-blue-400 text-white rounded-full p-2 hover:shadow-xl hover:shadow-black-500 transition-all active:scale-95 z-40"
            onClick={() => {
              setIsLoaded(false);
              loadFromFirebase();
            }}
                  ...
                  <div
                    className={
                      nowEditing && areaToEdit.id === area.id
                        ? "w-full flex flex-col justify-start items-start p-3 text-black bg-neutral-100 shadow-lg mb-5 rounded-xl border-2 border-black-500"
